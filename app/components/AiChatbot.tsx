...
export default function AiChatbot() {
    ...
    initialMessages: [
      {
        ...
        role: 'assistant',
        content:
          "Hello! I'm your ElimuPath Guidance Assistant. I can help you understand university placement, career paths, or how to choose the right course. I don't need your grades—just ask me anything!",
      },
    ],
  });
  ...
  if (!isOpen) {
    return (
      ...
      >
        ...
        <span className='font-black text-sm uppercase hidden md:inline'>
          Ask AI Guide
        </span>
      </button>
    );
  ...
  return (
    ...
    >
      {/* Header */}
      <div
        className='bg-black text-[#fffef3] p-3 flex items-center justify-between cursor-pointer'
        ...
        <>
          <div className='flex-1 overflow-y-auto p-4 space-y-4 bg-[#fffef3]'>
            {messages.map((msg) => (
              ...
              >
                <div
                  className={`w-8 h-8 rounded-full border-2 border-black flex items-center justify-center shrink-0 ${msg.role === 'user' ? 'bg-gray-200' : 'bg-[#cce023]'}`}
                >
